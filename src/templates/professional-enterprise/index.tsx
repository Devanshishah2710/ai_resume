/**
 * Professional Enterprise Standard Template
 *
 * Compact top header, single column, bold uppercase headings, and a left-railed
 * timeline for experience. Traditional corporate structure, maximum ATS
 * compatibility (plain flow, no columns in the body).
 */
...
export default function ProfessionalEnterpriseTemplate({ data, theme }: TemplateProps) {
