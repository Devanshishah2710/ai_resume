/**
 * Professional Premium Consultant Template
 *
 * Centered name with a horizontal contact bar beneath, then a balanced
 * two-column body (experience + projects left; education, skills, certs right).
 * Elegant spaced section titles, high-end corporate calm.
 */
...
export default function ProfessionalConsultantTemplate({ data, theme }: TemplateProps) {
    ...
    <div style={{ fontFamily: fontStack, fontSize, lineHeight, color: theme.textColor, backgroundColor: theme.backgroundColor, width: '210mm', minHeight: '297mm', padding: '15mm 16mm', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', gap: '14mm' }}>
        ...
        <div style={{ flex: '1.4', minWidth: 0 }}>
          {data.summary && (
            <>
              ...
              <p style={{ color: '#334155', marginBottom: gap }}>{data.summary}</p>
            </>
          )}
        ...
        <div style={{ flex: '1', minWidth: 0, borderLeft: `1px solid #e2e8f0`, paddingLeft: '12mm' }}>
          ...
          {references.length > 0 && (
            <>
              <SectionTitle style={{ ...rightTitle, marginTop: gap }}>References</SectionTitle>
              {references.map((ref) => (
