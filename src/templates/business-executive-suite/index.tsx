/**
 * Business Template — Executive Suite
 *
 * Concept: Right-aligned sidebar (28%) on a dark accent background — the first
 * and only right sidebar in the entire template library. The name sits in the
 * main (left) content area so the eye starts top-left and flows naturally.
 * Section titles use a short accent left-border bar instead of lines or fills.
 *
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3px', fontSize: `calc(${fontSize} * 0.8)`, color: '#cbd5e1' }}>
              ...
              return experience.length > 0 ? (
                <div key={section.id} style={{ marginBottom: gap }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '7px' }}>
                    <span style={{ display: 'inline-block', width: '3px', height: '16px', backgroundColor: accent, borderRadius: '1px' }} />
