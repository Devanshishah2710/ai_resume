...
export const templateRegistry: TemplateRegistry = {
  ...
  'minimal-center': {
    id: 'minimal-center',
    name: 'Minimal Center',
    description: 'A large centered name with a hairline contact bar and airy single-column flow.',
    category: 'minimal',
    tier: 'free',
    previewImageUrl: getTemplatePreviewUrl('minimal-center'),
    tags: ['minimal', 'centered', 'whitespace'],
    isAtsOptimized: true,
    supportsAvatar: false,
    supportsTwoColumns: false,
    createdAt: '2024-01-01',
    component: lazy(() => import('./minimal-center')),
  },
  'minimal-left': {
    id: 'minimal-left',
    name: 'Minimal Left',
    description: 'Left-anchored serif name with a thin contact bar and spacious single-column body.',
    category: 'minimal',
    tier: 'free',
    previewImageUrl: getTemplatePreviewUrl('minimal-left'),
    tags: ['minimal', 'editorial', 'left-aligned'],
    isAtsOptimized: true,
    supportsAvatar: false,
    supportsTwoColumns: false,
    createdAt: '2024-01-01',
    component: lazy(() => import('./minimal-left')),
  },
  'minimal-dual': {
    id: 'minimal-dual',
    name: 'Minimal Dual',
    description: 'Balanced two-column layout — experience on the left, supporting details on the right.',
    category: 'minimal',
    tier: 'free',
    previewImageUrl: getTemplatePreviewUrl('minimal-dual'),
    tags: ['minimal', 'two-column', 'balanced'],
    isAtsOptimized: true,
    supportsAvatar: false,
    supportsTwoColumns: true,
    createdAt: '2024-01-01',
    component: lazy(() => import('./minimal-dual')),
  },
  'minimal-timeline': {
    id: 'minimal-timeline',
    name: 'Minimal Timeline',
    description: 'Soft-gray header band with a quiet chronological experience timeline and clean rules.',
    category: 'minimal',
    tier: 'free',
    previewImageUrl: getTemplatePreviewUrl('minimal-timeline'),
    tags: ['minimal', 'timeline', 'soft-accent'],
    isAtsOptimized: true,
    supportsAvatar: false,
    supportsTwoColumns: false,
    createdAt: '2024-01-01',
    component: lazy(() => import('./minimal-timeline')),
  },
  'minimal-grid': {
    id: 'minimal-grid',
    name: 'Minimal Grid',
    description: 'Compact header over a refined two-column grid of small-caps section blocks.',
    category: 'minimal',
    tier: 'free',
    previewImageUrl: getTemplatePreviewUrl('minimal-grid'),
    tags: ['minimal', 'grid', 'structured'],
    isAtsOptimized: true,
    supportsAvatar: false,
    supportsTwoColumns: true,
    createdAt: '2024-01-01',
    component: lazy(() => import('./minimal-grid')),
  },
}
