...
export function AuthLayout({ children, title, subtitle }: AuthLayoutProps) {
  return (
    <div className="min-h-dvh flex">
      {/* ── Left Hero Panel ── */}
      <div className="hidden lg:flex lg:w-[55%] flex-col justify-between p-12 relative overflow-hidden bg-gradient-to-br from-[var(--color-accent)]/10 via-[var(--color-accent)]/5 to-[var(--color-accent-subtle)]/10">
        {/* Background blobs */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
          <div className="absolute -top-48 -right-48 w-96 h-96 rounded-full bg-[var(--color-accent)]/10 blur-3xl animate-blob" />
        ...
        <div className="relative z-10">
          <Link to={ROUTES.HOME} className="flex items-center gap-2.5 w-fit">
            <div className="h-9 w-9 rounded-lg bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center shadow-lg shadow-[var(--color-accent)]/10">
              <FileText className="h-5 w-5 inherit" />
            </div>
            <span className="text-xl font-bold inherit">{APP_NAME}</span>
          </Link>

          <div className="flex flex-wrap gap-2 mt-8">
            <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium rounded-full bg-white/10 text-[var(--color-text-primary)]  border border-white/10">
        ...
        <div className="relative z-10 -mt-8">
          <h1 className="text-4xl lg:text-5xl font-bold leading-tight inherit">
            Land Your Dream Job
            <br />
            With a Resume That
            <br />
          ...
          <p className="mt-4 text-base text-inherit max-w-md leading-relaxed">
        ...
        <div className="relative z-10 h-44">
          ...
          <div className="absolute bottom-8 left-48 w-32 animate-float-delayed">
            <div className="bg-white rounded-lg shadow-[0_10px_40px_rgba(15,23,42,0.05)] p-3 flex flex-col gap-1.5">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center">
                  <FileText className="h-3 w-3 inherit" />
                </div>
          ...
          <div className="absolute bottom-4 right-4 w-14 h-14 animate-float" style={{ animationDelay: '1.5s' }}>
            <div className="w-full h-full rounded-lg bg-gradient-to-br from-indigo-400 to-purple-600 flex items-center justify-center shadow-lg shadow-[var(--color-accent)]/10 ring-2 ring-white/20">
              <Bot className="h-7 w-7 inherit" />
            </div>
          </div>

          {/* Floating ATS score badge */}
          <div className="absolute top-0 right-12 w-24 animate-float-delayed">
            <div className="bg-white/10  rounded-lg border border-[var(--color-border)] p-3">
              <div className="flex items-center gap-2">
                <TrendingUp className="h-3.5 w-3.5 inherit" />
                <span className="text-[10px] font-medium text-inherit">ATS Score</span>
              </div>
              <p className="text-lg font-bold inherit mt-1">94%</p>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 lg:p-12 bg-[var(--color-bg-primary)]">
        ...
        >
          <div className="h-8 w-8 rounded-[var(--radius-md)] bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center">
            <FileText className="h-4 w-4 inherit" />
          </div>
        ...
        >
          <div className="bg-[var(--color-bg-elevated)] rounded-lg shadow-md border border-[var(--color-border)] p-8 sm:p-10">
            <div className="mb-8">
