...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-[var(--color-bg-secondary)]">
      {/* ── Top Bar ── */}
      <header
        className="h-[var(--topbar-height)] shrink-0 flex items-center justify-between px-4 lg:px-6 border-b border-[var(--color-border)] bg-[var(--color-bg-elevated)]/95  sticky top-0 z-40"
      >
          ...
          <div className="ml-2">
            <Dropdown
              ...
              trigger={
                ...
                >
                  <div className="h-7 w-7 rounded-full bg-[var(--color-accent)] flex items-center justify-center inherit text-xs font-semibold">
                    {profile?.avatarUrl ? (
                      <img
        ...
        <aside className="hidden lg:flex flex-col w-[var(--sidebar-width)] shrink-0 border-r border-[var(--color-border)] bg-[var(--color-bg-elevated)] py-4">
          ...
          <div className="px-3 pt-4 border-t border-[var(--color-border)] mt-2">
            <div className="flex items-center gap-3 px-3 py-2">
              <div className="h-8 w-8 rounded-full bg-[var(--color-accent)] flex items-center justify-center inherit text-xs font-semibold shrink-0">
                {initials}
              </div>
